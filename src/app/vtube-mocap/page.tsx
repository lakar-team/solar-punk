...
export const metadata: Metadata = {
    ...
    description: 'Real-time VTuber motion capture rig — face and body tracking driving procedural avatar animation.',
};
        ...
        <div className="min-h-screen bg-[#08080f] text-white overflow-x-hidden">
            ...
            <div className="border-y border-white/8 bg-white/[0.015]">
                <div className="max-w-5xl mx-auto px-6 py-10 grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
                    {[
                        { value: '52', label: 'ARKit Blend Shapes', sub: 'live facial tracking' },
                        { value: 'VRM', label: 'Avatar Format', sub: 'Live2D compatible too' },
                    ...
                    {[
                        {
                            ...
                            color: '#e879f9',
                            items: [
                                'ARKit 52-point blend shape mapping',
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                'Hand gesture recognition (optional)',
                            ],
                        },
                        {
                            ...
                            color: '#c084fc',
                            items: [
                                'VRM model loading and bone mapping',
                                'Live2D parameter driving (wip)',
            ...
            <section className="max-w-5xl mx-auto px-6 py-16 border-t border-white/8">
                <div className="flex flex-col md:flex-row items-center justify-between gap-6 p-8 bg-fuchsia-500/5 border border-fuchsia-500/15 rounded-2xl">
                    <div>
                        <div className="text-[10px] uppercase tracking-widest text-fuchsia-400/60 mb-2">Source Code</div>
                        <h3 className="text-xl font-bold text-white mb-2">Follow the build on GitHub</h3>
