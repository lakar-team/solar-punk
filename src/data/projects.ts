...
export type ProjectCategory = 'architecture' | 'digital' | 'products' | 'teaching';
...
export const categories: Category[] = [
    ...
    {
        id: 'teaching',
        name: 'Teaching & Diplomacy',
        description: 'Education and cultural bridge-building across three countries — architecture students in Malaysia, Japanese university students in Sendai, and local schoolchildren learning about Malaysia for the first time. Teaching as a form of knowledge transfer across cultures.',
        size: 6,
        color: '#7c3aed',
...
export const projects: Project[] = [
    ...
    },
    {
        ...
        emissiveColor: '#a78bfa',
        status: 'complete',
        description: 'Returned to my own alma mater as an Assistant Lecturer while simultaneously running Lakar Design. Over three years I taught Design Thinking and Human Sensibility to 200+ first-year architecture students — the same human-centred instincts I was deploying in practice every day. Teaching forced me to articulate what I\'d been doing intuitively.',
        orbitRadius: 20,
        orbitSpeed: 0.4,
        keyFacts: [
            '200+ students mentored in human-centric design',
            'Modules: Design Thinking & Human Sensibility',
            'Taught concurrently with running Lakar Design (2016–2019)',
            'Returned to UiTM as lecturer having won Dean\'s Award as a student',
        ],
        detailPage: '/teaching/uitm-lecturer',
    },
    {
        id: 'architecture-talks',
        name: 'Architecture Talks',
        type: 'research',
        category: 'teaching',
        size: 6,
        texture: 'planet-forest',
        ...
        status: 'complete',
        description: 'The same talk on Malaysian housing history — delivered twice, to two very different audiences. First at the Japan Institute of Architects professional symposium (Aug 2024), then at Tapio Hall\'s Open University community lecture series (Apr 2025), with live simultaneous interpreters. Both times, the audience asked questions. For a Japanese crowd, that\'s unusual.',
        orbitRadius: 30,
        orbitSpeed: 0.3,
        keyFacts: [
            'JIA 9th Architecture Salon — invited speaker, Aug 2024',
            'Tapio Open University — public lecture with live interpreter, Apr 2025',
            'Topic: Malaysian Housing Evolution — Then and Now',
            'Audience engagement noted by interpreter as unusually active for Japan',
        ],
        detailPage: '/teaching/architecture-talks',
    },
    {
        id: 'tohoku-teaching',
        name: 'Tohoku Teaching',
        type: 'work',
        category: 'teaching',
        size: 5,
        texture: 'planet-arctic',
        texturePath: '/textures/planet-arctic.png',
        emissiveColor: '#93c5fd',
        status: 'complete',
        description: 'A Malaysian teaching English — in Japanese — to Japanese university students who need it to graduate. The dynamic is unusual: a foreigner who learned English as a second language, now coaching Japanese students through a language he had to earn himself. Paid, formal, credited. Prepared exams, graded work, taught classes.',
        orbitRadius: 40,
        orbitSpeed: 0.22,
        keyFacts: [
            'Formal ESL TA — graduation-required credits, paid by Tohoku University',
            'Taught Japanese students in Japanese and English (2023–2025)',
            'Prepared quizzes, exams, marked and graded student work',
            'A foreigner who earned English as a 2nd language teaching it to Japanese students',
        ],
        detailPage: '/teaching/tohoku-teaching',
    },
    {
        id: 'sendai-school',
        name: 'Sendai School Visits',
        type: 'hobby',
        category: 'teaching',
        size: 5,
        texture: 'planet-tech',
        ...
        emissiveColor: '#fbbf24',
        status: 'in-progress',
        description: 'Cultural workshops for Japanese elementary school children, conducted entirely in Japanese. A 14-slide bilingual presentation covering Malaysian geography, food, traditional games, costumes, and school life — ending by teaching the kids to say Terima Kasih. Organised through MIA (Miyagi International Association).',
        orbitRadius: 50,
        orbitSpeed: 0.18,
        keyFacts: [
            'Workshops at Sendai elementary schools through MIA',
            'Presented entirely in Japanese',
            '14-slide bilingual visual deck — geography, food, games, costumes',
            'Final slide teaches children to say Terima Kasih (thank you in Malay)',
        ],
        detailPage: '/teaching/sendai-school',
    },
    {
        id: 'malaysia-japan-bridge',
        name: 'Malaysia-Japan Bridge',
        type: 'hobby',
        category: 'teaching',
        size: 5,
        texture: 'planet-lava',
        ...
        emissiveColor: '#fb923c',
        status: 'in-progress',
        description: 'The Malaysian community in Sendai had gone quiet for four years during COVID. Adam\'s public lecture work made him visible in local business circles. Sendai Gas — a company with Malaysia trade ties — reached out to restart the connection. The solution: food. Malaysian students cooked, the business community came, and what had been dormant for years came back to life.',
        orbitRadius: 60,
        orbitSpeed: 0.14,
        keyFacts: [
        ...
        detailPage: '/teaching/malaysia-japan-bridge',
    },
    {
        id: 'project-aibo',
        name: 'Project Aibo',
