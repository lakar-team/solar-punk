...
export const categories: Category[] = [
    ...
    },
    {
        id: 'digital',
        name: 'Digital',
        description: 'A five-year progression from AI collaboration to full-stack authorship — starting with LLM-assisted research at Tohoku where verification mattered more than generation speed, then building real tools from scratch because existing ones weren\'t precise enough. The output: a JIS pipe-flow hydraulic engineering suite, a RAG-based knowledge AI that cites before it speaks, a multi-core AI avatar with procedural expression, and a desktop VTuber mocap rig. Domain depth drove every build — architecture for HydroCalc, Islamic jurisprudence for the Sheikh AI, Japanese bilingual publishing for the Momotaro book. The through-line: precision over noise.',
        size: 7,
        color: '#3b82f6',
...
export const projects: Project[] = [
    ...
    },
    {
        ...
        orbitRadius: 58,
        orbitSpeed: 0.06,
        image: '/textures/merch-gemini.png',
    ...
    },
    {
        ...
        status: 'in-progress',
        description: 'A real-time desktop mocap app for VTuber streaming — connecting face and body tracking to a Live2D / VRM character model. The system drives procedural bone animation, mapping ARKit face blend shapes and full-body pose landmarks to a rigged digital avatar at runtime. Built as the Motor Core for the AIBO AI avatar system; runs locally as a standalone tool for streamers and developers who need precise, low-latency avatar control without a cloud dependency.',
        orbitRadius: 68,
        orbitSpeed: 0.035,
        detailPage: '/vtube-mocap',
        keyFacts: [
            'ARKit blend shapes → live real-time facial animation',
            'Full-body pose tracking via MediaPipe',
            'Drives VRM and Live2D avatar rigs',
